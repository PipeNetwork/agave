...
impl TransactionSigVerifier {
    pub fn new_reject_non_vote(
        ...
        let mut new_self = Self::new(packet_sender, forward_stage_sender, None);
    ...
    fn send_packets(
        ...
        if let Some(forward_stage_sender) = &self.forward_stage_sender {
            self.banking_stage_sender
                .send_with_input(banking_packet_batch.clone(), &self.input_tx_signature_sender)?;
            ...
            self.banking_stage_sender
                .send_with_input(banking_packet_batch, &self.input_tx_signature_sender)?;
        }
