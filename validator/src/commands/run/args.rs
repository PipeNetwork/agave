...
pub fn add_args<'a>(app: App<'a, 'a>, default_args: &'a DefaultArgs) -> App<'a, 'a> {
    ...
    .arg(
        Arg::with_name("fair_slashing")
            ...
            .takes_value(false)
            .help(
                "EXPERIMENTAL: Subscribe to leader-signed fair ordering commits and audit the \
...
mod tests {
    ...
    #[test]
    fn fair_requires_discovery_config() {
        let default_run_args = RunArgs::default();
    ...
    #[test]
    fn fair_slashing_requires_discovery_config() {
        let default_run_args = RunArgs::default();
        verify_args_struct_by_command_run_parse_is_error_with_identity_setup(
            default_run_args,
            vec!["--fair-slashing"],
    ...
    #[test]
    fn fair_slashing_enforce_requires_discovery_config() {
        let default_run_args = RunArgs::default();
        verify_args_struct_by_command_run_parse_is_error_with_identity_setup(
            default_run_args,
            vec!["--fair-slashing-enforce"],
        );
    }

    #[test]
    fn fair_slashing_enforce_accepts_api_token() {
        let default_run_args = RunArgs::default();
        verify_args_struct_by_command_run_with_identity_setup(
            default_run_args.clone(),
            vec![
